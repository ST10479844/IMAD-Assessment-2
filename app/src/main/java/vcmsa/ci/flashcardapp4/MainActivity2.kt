...
class MainActivity2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.Question1).text = "Leonardo da Vinci was a famous Renaissance artist"
        ...
        findViewById<Button>(R.id.Falsebutton).setOnClickListener {
            ...
            //When the start button is clicked it will navigate to screen 3.
